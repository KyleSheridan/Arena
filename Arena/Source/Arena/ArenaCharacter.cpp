...
AArenaCharacter::AArenaCharacter()
{
	...
	//load anim montage
	static ConstructorHelpers::FObjectFinder<UAnimMontage> KnightAttackMontageObject(TEXT("AnimMontage'/Game/Animations/Player/Knight_Attcak_Montage.Knight_Attcak_Montage'"));
	if (KnightAttackMontageObject.Succeeded())
	{
